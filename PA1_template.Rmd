...
The mean before and after is `r mean_steps_by_day` and `r clean_mean_steps_by_day` respectively whilst the media before and after is `r median_steps_by_day` and `r clean_median_steps_by_day` respectively.
